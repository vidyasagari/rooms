              ...
              <Card className="card-register">
                ...
                <CardBody>
                  <Form className="form" onSubmit={this.onSubmit}>
                    ...
                    <InputGroup
                      className={classnames({
                        "input-group-focus": this.state.contactNoFocus
                      })}
                    >
                      <InputGroupAddon addonType="prepend">
                        <InputGroupText>
                      ...
                      <Input
                        ...
                        type="text"
                        onFocus={e => this.setState({ contactNoFocus: true })}
                        onBlur={e => this.setState({ contactNoFocus: false })}
                      />
                    </InputGroup>
                    <InputGroup
                      className={classnames({
                    ...
                    >
                      ...
                      <Input
                        ...
                        type="text"
                        onFocus={e => this.setState({ confirmpassword: true })}
                        onBlur={e => this.setState({ confirmpassword: false })}
                      />
                    </InputGroup>
